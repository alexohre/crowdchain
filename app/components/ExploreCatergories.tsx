import { BarChart3, Rocket, Package, Settings, Users, Lightbulb, Mail } from "lucide-react";

export default function ExploreCategories() {
  const categories = [
    { name: "DeFi", icon: <img src="Defi.svg" alt="DeFi" className="h-6 w-6" /> },
    { name: "GameFi", icon: <img src="GameFi.svg" alt="GameFi" className="h-6 w-6" /> },
    { name: "NFTs", icon: <img src="NFT.svg" alt="NFTs" className="h-6 w-6" /> },
    { name: "Infrastructure", icon: <img src="infrastructure.svg" alt="Infrastructure" className="h-6 w-6" /> },
    { name: "Social", icon: <img src="social.svg" alt="Social" className="h-6 w-6" /> },
    { name: "Innovation", icon: <img src="innovation.svg" alt="Innovation" className="h-6 w-6" /> },
  ];
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-12 space-y-16">
      ...
      <section>
        <h2 className="text-[#000000] text-2xl font-bold mb-8">Explore Categories</h2>
