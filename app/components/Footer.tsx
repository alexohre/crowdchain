export default function Footer() {
  return (
    <footer className="bg-green-950 text-gray-300 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-extrabold mb-4">CrowdChain</h3>
            <p>
          ...
          <div>
            ...
            <p className="mb-3">Stay updated with the latest projects</p>
            <div className="flex">
              <input
                type="email"
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p>© 2025 CrowdChain. All rights reserved.</p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a
              href="https://x.com/crowdchainHQ"
              target="_blank"
            ...
            <a
              href="https://github.com/alexohre/crowdchain"
              target="_blank"
              className="hover:text-green-300"
            >
              <svg
