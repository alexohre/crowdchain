      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:block">
            <button className="bg-[#1A5D1A] hover:bg-green-700 text-white py-2 px-4 rounded-md">Connect Wallet</button>
          </div>
          ...
          <div className="flex items-center gap-3 md:hidden">
            ...
            <button className="bg-[#1A5D1A] hover:bg-green-700 text-white py-2 px-4 rounded-4xl">Connect</button>
          </div>
        </div>
      </div>
